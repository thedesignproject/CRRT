...
describe('dashboard audit launcher link', () => {
  it('uses the dashboard base-aware audit route', () => {
    render(<Header
      ...
      addProjectOpen={false} setAddProjectOpen={vi.fn()} onAddProject={vi.fn()} onCheckAvailability={vi.fn()} addProjectBusy={false} addProjectError={null} onOpenCmd={vi.fn()} onOpenSettings={vi.fn()} settingsActive={false} onOpenExtensionComments={vi.fn()} extensionCommentsActive={false}
